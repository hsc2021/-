...
def setup_exp(TransportApp="FIFO", logger_level=logging.INFO):
    ...
    print(net.route.query(n3, n6))
    print(net.query_route(n3, n6))
    ...
    try:
        ...
        print("not connected path between two nodes")
        return
...
class SIMU(MPSimulations):
    def run(self, setting):
        ...
        print(f"finish simulation {setting}")
        return ret


if __name__ == "__main__":
    print(setup_exp(TransportApp="PS", logger_level=logging.INFO))